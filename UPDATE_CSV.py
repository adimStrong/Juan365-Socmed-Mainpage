...
TARGET_FILE = EXPORTS_DIR / 'Juan365_MERGED_ALL.csv'
...
def backup_existing():
    ...
    if TARGET_FILE.exists():
        ...
        backup_path = BACKUP_DIR / f'Juan365_MERGED_ALL_backup_{timestamp}.csv'
...
def main():
    """Main GUI"""
    root = tk.Tk()
    root.title("Juan365 CSV Updater")
    root.geometry("500x400")
    root.configure(bg='#1a1a2e')

    # Title
    title = tk.Label(root, text="Juan365 CSV Data Updater",
